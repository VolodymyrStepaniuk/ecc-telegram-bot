...
import org.stepaniuk.telegrambot.sender.EncryptionBotSender;
...
public class TelegramService {
    ...
    private final EncryptionBotSender botSender;

    public TelegramService(EncryptionBotSender botSender) {
